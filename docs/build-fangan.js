...
bodyChildren.push(C.body("工程机械经销商参与设备采购投标频繁，一份标书的资格自查与技术偏离表制作通常耗时2至3天。投标规则复杂：16类以上技术参数、★关键条款、在线解密时限、保证金账户要求，任一疏漏即导致废标——保证金没收、订单旁落、信用受损。更深层的问题是：老师傅的避坑经验存在于个人头脑中，难以沉淀为组织能力，新人每次都要重新交学费。"));
...
bodyChildren.push(C.bullet("技术偏离表：", "16类技术参数逐条响应，标注满足/正偏离/负偏离/资料库无/待人工补充五态；"));
...
bodyChildren.push(C.bullet("AI原生开发方法论：", "以提示词工程、规则库与115项自动化测试替代传统编码，快速交付可验证产品。"));

/* 五、实施计划 */
bodyChildren.push(C.h1("五、实施计划与里程碑"));
bodyChildren.push(C.tbl(["阶段", "时间", "目标与交付"], [
  ["已完成", "至今", "V1.7可运行产品：四大输出、32类参数7大机型族、对比选型、★▲双级风控、公告变更检测、自定义词库、PWA；115项自动化测试全绿"],
...
bodyChildren.push(C.tbl(["风险", "对策"], [
  ...
  ["团队工程经验不足", "115项自动化测试锁定行为；重大变更先写测试再改代码"],
], [3400, 6700]));
  ...
  sections: [
    { properties: { page: { size: pageSize, margin: { top: 0, bottom: 0, left: 0, right: 0 } } },
      children: C.buildCoverR2({
        ...
        title: "标书快反项目方案文档",
        subtitle: "基于反幻觉双引擎的工程机械投标文件智能生成系统 · V1.7",
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("docs/方案文档-标书快反.docx", buf);
  console.log("DOCX done: docs/方案文档-标书快反.docx");
});
