...
bodyChildren.push(C.bullet("AI原生开发方法论：", "以提示词工程、规则库与142项自动化测试替代传统编码，快速交付可验证产品。"));

/* 五、实施计划 */
bodyChildren.push(C.h1("五、实施计划与里程碑"));
bodyChildren.push(C.tbl(["阶段", "时间", "目标与交付"], [
  ["已完成", "至今", "V2.1.1可运行产品并已部署上线（在线体验：https://azzb66223944qq.github.io/bidpilot/）：四大输出、32类参数7大机型族、对比选型、★▲双级风控、公告变更检测、自定义词库、PWA；142项自动化测试+6组黄金快照全绿（GitHub Actions徽章）"],
...
bodyChildren.push(C.tbl(["风险", "对策"], [
  ...
  ["团队工程经验不足", "142项自动化测试锁定行为；重大变更先写测试再改代码"],
], [3400, 6700]));
