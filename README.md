...
工程机械投标文件 AI 智能体（**v1.7**）。输入**本公司资料库** + **招标公告**，10 秒生成四份投标必备成果：
...
运行测试（65 项断言，四机型场景+单位换算+权重配置+HTML报告+补料清单，见 `tests/engine.test.js`）：
...
├── tests/
│   └── engine.test.js    # 115 项自动化测试（node tests/engine.test.js）
├── docs/
